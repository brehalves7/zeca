...
export function SidebarContent({ userEmail, closeMenu, showCloseButton = false }: SidebarContentProps) {
    ...
    <div className="flex flex-col h-full p-6 bg-[#101216]">
      ...
      <div className="flex items-center justify-between px-3 mb-10">
        ...
        {showCloseButton && (
          <button
            onClick={closeMenu}
            className="lg:hidden p-1 text-gray-500 hover:text-white transition-colors border border-white/10 rounded-lg hover:bg-white/5"
